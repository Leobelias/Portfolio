...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className={`contact reveal reveal--up ${isVisible ? "active" : ""}`}
    >
      <div className="container">
        <h2 className="heading--lg heading--with-line text-center">
          Contactez-moi
        </h2>
        <p className="text--lg text-center contact__intro">
          Je suis toujours ravi d'échanger avec de nouvelles personnes. Que vous
          ayez une question, une idée de projet ou autre n'hésitez pas à me
        ...
        <div className="contact__info-container">
          <div className="contact__info-item">
            ...
            >
              leoblaise14@gmail.com
            </a>
          </div>
          <div className="contact__info-item">
            <h3 className="contact__info-title">Réseaux Sociaux</h3>
            <div className="contact__socials">
              ...
              <a
                href="https://www.linkedin.com/in/leoblaise/"
                target="_blank"
                rel="noopener noreferrer"
                className="contact__social-link"
              >
